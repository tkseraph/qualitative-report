...
def _prepare_public_report(
    ...
    *,
    ...
    compliance = (
        ...
        f'<strong class="publication-site-name">{html_lib.escape(site_name)}</strong>'
        f'<span class="publication-registered-name">{html_lib.escape(registered_name)}</span>'
