...
.report-body .chart-container{height:268px;margin:10px 0 12px;padding:8px 5px 10px;border-radius:10px}
...
def _chart_canvas_html(
    ...
    return (
        f'<div class="chart-container" data-chart-id="{html.escape(chart_id, quote=True)}" data-chart-type="{chart_type}" data-chart-kind="{_chart_kind(chart_type)}" data-chart-visual="{_chart_visual_grammar(chart_type)}" data-chart-window="{payload.get("window", "all")}" data-mobile-density="reduced" data-mobile-value-labels="collision-aware" data-chart-title="{html.escape(display_title, quote=True)}" '
